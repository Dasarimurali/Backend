...
public interface MessageRepository extends CrudRepository<Message, Integer> {
	...
	/*
	 * * This method will retrieve all messages in database which are sent between
	 * two * specific users specified in the method parameters. The messages should
	 * come * ordered by postedDate in descending order * * Write a query to
	 * retrieve all messages from the database send between two specified users. *
	...
	public List<Message> showMessagesWithTag(String tag, Integer pages);
